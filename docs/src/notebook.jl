...
begin
	...
	using Astroalign, AstroImages, PlutoPlotly, PlutoUI, PSFModels, Rotations, ImageTransformations, CoordinateTransformations, LinearAlgebra, Random
...
# ╔═╡ 9fd4b5be-b7ff-478c-b7cc-c2943777321c
ransac_kwargs = (;
	scale = true,
...
# ╔═╡ 33aeeb01-e3c8-407b-8da1-4ef69f20428b
@mdx """
...
# ╔═╡ 7a69b9b4-bf47-4724-8870-df695277ef3c
@mdx """
<div style="display: flex; gap: 1rem;">
...
# ╔═╡ f43c6f7f-f97a-4a0f-900b-4e2fadebc810
phot_from, phot_from_params = Astroalign._photometry(img_from; phot_kwargs...)

# ╔═╡ 7990c8be-9425-47d0-a913-9e2bb4fbefd1
img_aligned_from = shareheader(img_from, warp(img_from, inv(tfm), axes(img_to)));
...
plot_pair(img_from, img_to;
	...
	aps_left = phot_from_params.aps,
	aps_left_line_color = :lightgreen,
	aps_right = phot_to_params.aps,
...
plot_pair(img_from, img_to;
	column_titles = ["img_from", "img_to"],
	aps_left = params_aligned.aps_sol_from,
	aps_right = params_aligned.aps_sol_to,
)
